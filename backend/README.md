...
## Project Structure
    ...
    ├── exploring_features__26749  # Django project configurations
...
1. Clone this repo and `cd exploring_features__26749`
...
2. Clone this repo and `cd exploring_features__26749`
